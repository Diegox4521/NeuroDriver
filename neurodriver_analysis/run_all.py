...
def _write_paper_numbers(report, triangulation_df, out_path):
    ...
    lines = [
        ...
        f'  Paper figure: chi^2 = 5.882, p = 0.0153',
        '',
        ...
        f'  Paper figure: LiDAR 25.6 +/- 4.6, Camera 14.4, Speedometer 13.2 +/- 8.7',
        '',
        '== LIDAR DOMINANCE ==',
        ...
        f'  Paper figure: 76.5% (paper used a different multi-select scoring rule;',
        f'  see README "Survey scoring caveats" section).',
        '',
        '== TRIANGULATION ==',
        ...
        f'  Paper figure: 8 themes, 6 strong, 2 moderate',
    ]
